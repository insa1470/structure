...
PROMPT_CHART1 = """這是一張企業股權結構圖。圖中有多個方框，每個方框代表一家公司，公司名稱以豎排文字寫在方框內。方框之間有連線代表股權關係，由上而下是母公司到子公司的層級。

請仔細辨識圖中【所有】方框內的公司名稱，包括：
- 圖中央大框的公司
- 左右兩側排列的細長方框（豎排文字）
- 每一層級的所有公司，不要遺漏

規則：
- 只輸出圖片中實際可見的文字，禁止猜測或省略
- level：頂層主體=0，一級子公司=1，依此類推
- parent：填上層公司全名，頂層填null
- ratio：填持股比例如"51.2%"，無則填null
- 務必列出圖中每一個方框對應的公司，不得只列部分
